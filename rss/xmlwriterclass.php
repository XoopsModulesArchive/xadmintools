...
if (!defined('METAL_LIBRARY_XML_XML_WRITER_CLASS')) {
    ...
    class xml_writer_class
    {
        ...
        public $generatedcomment = 'Generated by: http://www.phpclasses.org/xmlwriter $Revision: 1.32 $';
        ...
        public function encodedata($data, &$encodeddata)
        {
            if (!strcmp($this->inputencoding, $this->outputencoding)) {
                ...
                switch (mb_strtolower($this->outputencoding)) {
                case 'utf-8':
                    if (!strcmp(mb_strtolower($this->inputencoding), 'iso-8859-1')) {
                    ...
                    break;
                case 'iso-8859-1':
                    if (!strcmp(mb_strtolower($this->inputencoding), 'utf-8')) {
        ...
        public function writetag(&$output, $path, $indent)
        {
            ...
            if ($attributecount > 0) {
                ...
                $end = ('string' != gettype($key = key($attributes)));
            ...
            if ($elements > 0) {
                ...
                for (; $element < $elements;) {
                    $elementpath = ($path . ',' . (string)$element);
        ...
        public function addtag($tag, &$attributes, $parent, &$path, $indent)
        {
            ...
            $path = ((!strcmp($parent, '')) ? '0' : ($parent . ',' . (string)$this->structure[$parent]['Elements']));
            ...
            $end = ('string' != gettype($attribute_name = key($attributes)));
            ...
            if (strcmp($parent, '')) {
                $this->structure[$parent]['Elements'] += 1;
            }
        ...
        public function adddata($data, $parent, &$path)
        {
            ...
            $path = ($parent . ',' . (string)$this->structure[$parent]['Elements']);
